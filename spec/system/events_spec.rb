...
RSpec.describe '駐車場借用登録', type: :system do
  before do
    ...
    @event1.start_date = Faker::Time.between(from: @park1.start_time + 15.minutes,
                                             to: @park1.end_time - 15.minutes).ceil_to(15.minutes)
    ...
    @event2.start_date = Faker::Time.between(from: @park1.start_time + 15.minutes,
                                             to: @park1.end_time - 15.minutes).ceil_to(15.minutes)
...
RSpec.describe '駐車場借用キャンセル', type: :system do
  before do
    ...
    @event1 = FactoryBot.create(:event, user_id: @user1.id, car_id: @car1.id, park_id: @park1.id, start_date: start_date1,
                                        end_date: end_date1)
    ...
    @event2 = FactoryBot.create(:event, user_id: @user2.id, car_id: @car2.id, park_id: @park1.id, start_date: start_date2,
                                        end_date: end_date2)
