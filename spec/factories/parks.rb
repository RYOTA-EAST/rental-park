FactoryBot.define do
  factory :park do
    ...
    start_time { Faker::Time.between(from: DateTime.now + 1, to: DateTime.now + 2).ceil_to(15.minutes) }
    end_time { Faker::Time.between(from: DateTime.now + 3, to: DateTime.now + 10).ceil_to(15.minutes) }
    rending_stop { false }
